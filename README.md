L'application est développée avec Angular pour le Front-end et repose sure Spring boot pour le Back-end.
...
Un historique permet de suivre les modifications des cases.
L'admin bénéficie de priviléges supplémentaires, nottamment la gestion des utilisteurs et l'accés à l'historique global.
